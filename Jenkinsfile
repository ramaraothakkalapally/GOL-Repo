...
// for display purpose
      ...
      git 'https://github.com/ramaraothakkalapally/GOL-Repo.git'
...
post {
       ...
       failure {
           mail to:"ramarao.thakkalapally@gmail.com", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
